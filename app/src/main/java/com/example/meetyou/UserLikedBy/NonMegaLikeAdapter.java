...
public class NonMegaLikeAdapter extends ArrayAdapter<NonMegaLikeItem> {

    private Context context;
    private int resource;

    public NonMegaLikeAdapter(Context context, int resource, List<NonMegaLikeItem> items) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        NonMegaLikeItem item = getItem(position);
        if (item != null) {
