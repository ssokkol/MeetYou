...
public class LuxeMegaLikeAdapter extends ArrayAdapter<LuxeMegaLikeItem> {

    private Context context;
    private int resource;

    public LuxeMegaLikeAdapter(Context context, int resource, List<LuxeMegaLikeItem> items) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        LuxeMegaLikeItem item = getItem(position);
        if (item != null) {
            TextView nameText = view.findViewById(R.id.name_text_view);
            getName(item.getName(), new LuxeMegaLikeAdapter.OnNameReceivedListener() {
                @Override
                public void onNameReceived(String name) {
                    getAge(item.getName(), new LuxeMegaLikeAdapter.OnAgeReceivedListener() {
                        @Override
    ...
    private void getName(String UID, final LuxeMegaLikeAdapter.OnNameReceivedListener listener) {
    ...
    private void getAge(String UID, final LuxeMegaLikeAdapter.OnAgeReceivedListener listener) {
