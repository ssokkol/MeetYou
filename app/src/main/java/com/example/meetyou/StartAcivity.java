...
import com.example.meetyou.databinding.ActivityStartAcivityBinding;
...
public class StartAcivity extends AppCompatActivity {
    ...
    private boolean isUserLoggedIn() {
        ...
        // Возможно, вам также потребуется дополнительная проверка на валидность пользовательских данных, ну ты же напишешь там её
