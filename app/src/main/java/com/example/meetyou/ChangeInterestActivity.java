...
import com.example.meetyou.databinding.ActivityChangeInterestBinding;

public class ChangeInterestActivity extends AppCompatActivity {

    ActivityChangeInterestBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityChangeInterestBinding.inflate(getLayoutInflater());
        ...
        binding.goNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!isGoNextActive)
                {
                    NotificationHelper.showCustomNotification(ChangeInterestActivity.this, null, getString(R.string.choose_a_few_interests_message), getString(R.string.close), 0, 0, 0,0);
                } else if(Counter <= 5 )
                {
                    ...
                    NotificationHelper.showCustomNotification(ChangeInterestActivity.this, null, getString(R.string.select_nm_5_interests_message), getString(R.string.close), 0, 0, 0,0);
                }
            }
        });
